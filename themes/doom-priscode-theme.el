;;; doom-priscode-theme.el --- an original dark theme -*- lexical-binding: t; no-byte-compile: t; -*-
;;
...
;;; Variables
(defgroup doom-priscode-theme nil
  "Options for the `doom-priscode' theme."
  :group 'doom-themes)

(defcustom doom-priscode-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-priscode-theme
  :type 'boolean)

(defcustom doom-priscode-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-priscode-theme
  :type 'boolean)

(defcustom doom-priscode-comment-bg doom-priscode-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-priscode-theme
  :type 'boolean)

(defcustom doom-priscode-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-priscode
  "A dark theme inspired by Acario"

  ;; name        default   256         16
  ((bg         '("#000000" "color-233" "black"        ))
   (bg-alt     '("#000000" "color-232" "brightblack"  ))
   ...
   (red        '("#FF0000" "color-167" "red"          ))
   (green      '("#79D836" "color-113" "green"        ))
   (yellow     '("#D8B941" "color-179" "yellow"       ))
   (blue       '("#0066F6" "color-68"  "blue"         ))
   (magenta    '("#7C29EF" "color-98"  "magenta"      ))
   ...
   (selection      bg-blue)
   (builtin        blue)
   (comments       (if doom-priscode-brighter-comments bg-cyan grey))
   (doc-comments   (doom-lighten (if doom-priscode-brighter-comments bg-cyan green) 0.25))
   (constants      magenta)
   (functions      yellow)
   (keywords       red)
   (methods        cyan)
   ...
   ;; custom categories
   (hidden bg)
   (-modeline-bright doom-priscode-brighter-modeline)
   (-modeline-pad
    (when doom-priscode-padded-modeline
      (if (integerp doom-priscode-padded-modeline) doom-priscode-padded-modeline 4)))
  ...
  ((font-lock-comment-face
    :slant 'italic
    :foreground comments
    :background (if doom-priscode-comment-bg (doom-lighten bg 0.05)))
   (font-lock-doc-face
...
;;; doom-priscode-theme.el ends here
